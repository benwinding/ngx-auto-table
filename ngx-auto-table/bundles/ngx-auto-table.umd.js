(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ctrl/ngx-csv'), require('@angular/common'), require('@angular/router'), require('@angular/material'), require('rxjs'), require('@angular/forms'), require('@angular/cdk/collections'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-auto-table', ['exports', '@ctrl/ngx-csv', '@angular/common', '@angular/router', '@angular/material', 'rxjs', '@angular/forms', '@angular/cdk/collections', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['ngx-auto-table'] = {}),global.ngxCsv,global.ng.common,global.ng.router,global.ng.material,global.rxjs,global.ng.forms,global.ng.cdk.collections,global.rxjs.operators,global.ng.core));
}(this, (function (exports,ngxCsv,common,router,material,rxjs,forms,collections,operators,core) { 'use strict';
...
//# sourceMappingURL=ngx-auto-table.umd.js.map